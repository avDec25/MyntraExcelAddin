...
namespace MyntraExcelAddin.Constant
{
    static class ColumnMeta
    {
        ...
        public static readonly IList<String> ColumnHeader = new ReadOnlyCollection<string> (new List<String> {                
                ...
                "Sub-Category",
                "Fabric 1- Quality",
                "Fabric 1- solid / print (Impression)",
                "Fabric 1- Base Color (Pantone)",
                "Fabric 1- Print Code",
                "Fabric 1- Technique",
                "Fabric 2- Quality",
                "Fabric 2- solid / print (Impression)",
                "Fabric 2- Base Color (Pantone)",
                "Fabric 2- Print Code",
                "Fabric 2- Technique",
                "Fabric 3- Quality",
                "Fabric 3- solid / print (Impression)",
                "Fabric 3- Base Color (Pantone)",
                "Fabric 3- Print Code",
                "Fabric 3- Technique",
                "Fabric 4- Quality",
                "Fabric 4- solid / print (Impression)",
                "Fabric 4- Base Color (Pantone)",
                "Fabric 4- Print Code",
                "Fabric 4- Technique",
                "Fabric 5- Quality",
                "Fabric 5- solid / print (Impression)",
